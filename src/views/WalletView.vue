      ...
      <div v-else class="flex flex-col lg:flex-row gap-4">
        ...
        <aside class="lg:w-72 flex-shrink-0">
          ...
          <div class="bg-white shadow-card rounded-sm p-4 mb-4">
            <div class="flex items-center gap-4">
              <div class="w-14 h-14 flex-shrink-0 bg-flipkart-blue text-white rounded-full 
              ...
              <div>
                ...
                <p class="text-xl font-bold text-flipkart-blue">
            ...
            <!-- Pending Cashback -->
            <div class="mt-4 pt-4 border-t border-flipkart-gray-dark">
              <div class="flex items-center justify-between">
                <span class="text-sm text-text-secondary">Pending Cashback</span>
                <span class="text-sm font-medium text-flipkart-orange">
          ...
          <div class="bg-white shadow-card rounded-sm mt-4 p-4">
            ...
            <div class="space-y-2">
              <RouterLink to="/orders" class="flex items-center gap-2 text-sm text-text-primary hover:text-flipkart-blue">
              ...
              <RouterLink to="/products" class="flex items-center gap-2 text-sm text-text-primary hover:text-flipkart-blue">
                <svg width="16" height="16" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <main class="flex-1 min-w-0">
          ...
          <div v-if="activeSection === 'balance'" class="bg-white shadow-card rounded-sm">
            ...
            <div class="p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="p-4 bg-flipkart-gray rounded-sm">
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-flipkart-blue/10 rounded-full flex items-center justify-center">
                      <svg width="20" height="20" class="w-5 h-5 text-flipkart-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                ...
                <div class="p-4 bg-flipkart-gray rounded-sm">
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-flipkart-orange/10 rounded-full flex items-center justify-center">
                      <svg width="20" height="20" class="w-5 h-5 text-flipkart-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                              d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/>
                      </svg>
                    </div>
                    <div>
                      ...
                      <p class="text-2xl font-bold text-flipkart-orange">
                        ₹{{ pendingCashback.toLocaleString('en-IN', { minimumFractionDigits: 2 }) }}
                      </p>
                    </div>
                  </div>
              ...
              <div class="p-4 bg-blue-50 border border-blue-100 rounded-sm">
                <h3 class="font-medium text-flipkart-blue mb-2">How to earn cashback</h3>
                <ul class="text-sm text-text-secondary space-y-1">
                  <li class="flex items-start gap-2">
                    <span class="text-flipkart-green mt-0.5">✓</span>
          ...
          <div v-if="activeSection === 'redeem'" class="bg-white shadow-card rounded-sm">
            ...
            <div class="p-6">
              <div class="max-w-md">
                <div class="p-4 bg-flipkart-gray rounded-sm mb-6">
                  <div class="flex items-center justify-between mb-2">
                    <span class="text-sm text-text-secondary">Available to Redeem</span>
                    <span class="text-lg font-bold text-flipkart-orange">
                      ₹{{ pendingCashback.toLocaleString('en-IN', { minimumFractionDigits: 2 }) }}
                    </span>
                  </div>
                  <div class="w-full bg-flipkart-gray-dark rounded-full h-2">
                    <div 
                      class="bg-flipkart-orange h-2 rounded-full transition-all"
            ...
            <div class="p-6">
              ...
              <div class="space-y-4">
                <div 
                  ...
                  :key="item.id"
                  class="flex items-center gap-4 p-4 border border-flipkart-gray-dark rounded-sm 
                         hover:border-flipkart-blue transition-colors"
                >
                  <div class="w-16 h-16 bg-flipkart-gray rounded-sm flex items-center justify-center flex-shrink-0">
                    <svg width="32" height="32" class="w-8 h-8 text-flipkart-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-4 mt-2">
                      <span class="text-lg font-bold text-flipkart-blue">
                  ...
                  <button
                    ...
                    :class="[
                      ...
                      balance >= item.price ? 'btn-primary' : 'bg-flipkart-gray text-text-hint cursor-not-allowed'
                    ]"
                  >
              ...
              <div v-if="purchasedFlag" class="mt-6 p-6 bg-green-50 border border-flipkart-green rounded-sm text-center">
                <div class="w-16 h-16 bg-flipkart-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg width="32" height="32" class="w-8 h-8 text-flipkart-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                          d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                </div>
                <h3 class="text-lg font-bold text-flipkart-green mb-2">Congratulations!</h3>
                <p class="text-sm text-text-secondary mb-4">You've unlocked the secret reward!</p>
                <div class="inline-block px-6 py-3 bg-white border-2 border-dashed border-flipkart-green rounded-sm">
                  <code class="text-lg font-mono font-bold text-text-primary">{{ purchasedFlag }}</code>
                </div>
              </div>

              <!-- Hint -->
              <div class="mt-6 p-4 bg-flipkart-gray rounded-sm">
